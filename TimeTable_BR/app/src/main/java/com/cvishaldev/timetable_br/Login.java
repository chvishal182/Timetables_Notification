    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logInto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(),userLogMail+"\n"+userLogPass,Toast.LENGTH_LONG).show();
    ...
    private void loginUser() {
        ...
        logAuth.signInWithEmailAndPassword(userLogMail,userLogPass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                {
                    Intent toViewTimeTable = new Intent(getApplicationContext(), com.cvishaldev.timetable_br.ViewTT.class);
